...
- [x] **DIAG-03**: Every entry in `src/Converj.Generator/AnalyzerReleases.Unshipped.md` is updated to use the new `Category` string for consistency with the descriptors
