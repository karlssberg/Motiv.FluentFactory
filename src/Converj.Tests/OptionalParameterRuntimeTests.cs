...
[FluentRoot]
internal partial class OptionalParamBuilder;

[FluentTarget<OptionalParamBuilder>]
internal record OptionalTarget(string Name, int Count = 10);

[FluentRoot]
internal partial class AllOptionalBuilder;

[FluentTarget<AllOptionalBuilder>]
...
public class OptionalParameterRuntimeTests
{
    ...
    {
        var result = OptionalParamBuilder.WithName("test").CreateOptionalTarget();
    ...
    {
        var result = OptionalParamBuilder.WithName("test").WithCount(99).CreateOptionalTarget();
    ...
    {
        var result = AllOptionalBuilder.CreateAllOptionalTarget();
    ...
    {
        var result = AllOptionalBuilder.WithX(10).WithY(20).WithZ(30).CreateAllOptionalTarget();
    ...
    {
        var result = AllOptionalBuilder.WithY(50).CreateAllOptionalTarget();
