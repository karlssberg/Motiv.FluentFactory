...
public class MergeDissimilarStepsTests
{
    ...
    /// <summary>
    /// Issue #12: CreateMethod.None taints merged metadata asymmetrically.
    /// Two constructors share the prefix (string name). Alpha uses CreateMethod.None (returns Alpha directly),
    /// Beta uses CreateMethod.Dynamic (creates via CreateBeta()). After the shared WithName step,
    /// both paths must be reachable — the None shouldn't prevent Beta's creation method.
    /// </summary>
    [Fact]
    internal async Task Should_preserve_both_paths_when_none_and_dynamic_constructors_share_prefix()
    {
        const string code =
            """
            using System;
        ...
        const string expected =
            ...
            namespace Test
            {
                ...
                public static partial class Factory
                {
                    ...
                    /// </summary>
                    [global::System.Runtime.CompilerServices.MethodImpl(global::System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
                    public static global::Test.Alpha WithName(in string name)
                    {
                        return new global::Test.Alpha(name);
                    }
                }
                ...
                public readonly struct Step_1__Test_Factory
                {
                    ...
                    /// <summary>
                    /// Creates a new instance using constructor Test.Beta.Beta(string name, int age).
                    ///
                    ///     <seealso cref="Test.Beta"/>
                    /// </summary>
                    [global::System.Runtime.CompilerServices.MethodImpl(global::System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
                    ...
                    {
                        return new global::Test.Beta(this._name__parameter, this._age__parameter);
                    }
                }
            }
            """;
    ...
    [Fact]
    internal async Task Should_preserve_both_paths_when_none_and_dynamic_constructors_have_identical_parameters()
    {
        const string code =
            """
            using System;
        ...
        const string expected =
            ...
            namespace Test
            {
                ...
                public partial class Alpha
                {
                    ...
                    public global::Test.Beta CreateBeta()
                    {
                        return new global::Test.Beta(this.Name);
                    }
                }
            }
            """;
