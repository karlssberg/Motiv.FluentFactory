...
public class DiagnosticsTests
{
        ...
        const string expected =
            ...
            namespace Test
            {
                ...
                public readonly struct Step_0__Test_Spec<TModel, TPredicateResult>
                {
                    ...
                    {
                        return new global::Test.ExplanationExpressionTreePropositionFactory<TModel, TPredicateResult>(this._expression__parameter, global::Test.WhenTrueOverloads.WhenTrue<TModel, global::Test.BooleanResultBase<string>, string>(whenTrue));
                    }
    ...
    [Fact]
    internal Task Given_superseded_multi_method_record_declared_after_regular_method_record_Should_report_unreachable_on_multi_method_record()
    {
        const string code =
            """
        ...
        const string expected =
            ...
            namespace Test
            {
                ...
                public partial class Factory
                {
                    ...
                    {
                        return new global::Test.First(value1);
                    }
                }
                ...
                public readonly struct Step_1__Test_Factory
                {
                    ...
                    {
                        return new global::Test.SecondA(this._value1__parameter, this._value2__parameter, value3);
                    }
                }
            }
            """;
                ...
                ExpectedDiagnostics =
                {
                    ...
                    new DiagnosticResult(FluentMethodTemplateSuperseded.Id, Info)
                        ...
                        .WithArguments(
                            ...
                            "Test.SecondB.SecondB(int value1, int value2, int value3)",
                            "int value2",
                            "Test.SecondA.SecondA(int value1, int value2, int value3)")
                },
                GeneratedSources =
                {
                    (typeof(FluentFactoryGenerator), "Test.Factory.g.cs", expected)
    ...
    [Fact]
    internal Task Given_superseded_multi_method_record_declared_after_regular_method_record_Should_report_unreachable_on_multi_method_record_when_in_different_order()
    {
        const string code =
            """
            using Converj.Attributes;
        ...
        return new VerifyCS.Test
        {
            TestState =
            {
                ...
                ExpectedDiagnostics =
                {
                    ...
                    DiagnosticResult
                        .CompilerWarning(ContainsSupersededFluentMethodTemplate.Id)
                        .WithSpan(SourceFile, 15, 28, 15, 51)
                        .WithSpan(SourceFile, 21, 33, 21, 39)
                        .WithArguments(
                            "Test.MultipleMethods.Value2(int value2)",
                            "int value2",
                            "Test.SecondB.SecondB(int value1, int value2, int value3)",
    ...
    [Fact]
    internal Task Given_one_superseded_multi_method_and_one_non_superseded_multi_method_record_declared_after_regular_method_record()
    {
        const string code =
            """
            using Converj.Attributes;
